...
Public Class Barcodescan
    ...
    Private Sub TextBox1_TextChanged_1(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        If TextBox1.Text = "" Or TextBox1.Text = "Your Text Here" Then
            PictureBox1.Image = Nothing
        Else
            encodebarcode.IncludeLabel = True
            encodebarcode.CustomLabel = TextBox1.Text
            Try
                PictureBox1.Image = encodebarcode.Encode(MessagingToolkit.Barcode.BarcodeFormat.Code128, TextBox1.Text)
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        End If
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Try
            resultDecoder = barcodeDecoder.Decode(New Bitmap(PictureBox1.Image))
            TextBox1.Text = resultDecoder.Text
        Catch ex As Exception
            MsgBox("Gagal Decode!")
        End Try
    End Sub
    ...
    Private Sub QRscan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Button2.Enabled = False
        Button3.Enabled = False
        ' TextBox1.Text = Transaksi.TextBox11.Text
    End Sub
End Class