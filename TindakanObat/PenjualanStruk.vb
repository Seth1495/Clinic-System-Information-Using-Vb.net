...
Public Class PenjualanStruk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TindakanObat.PenjualanStruk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenjualanStruk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenjualanStruk = New PenjualanStruk()
        rpt.Site = Me.Site
        Return rpt
    End Function
